...
Before you can build this project, you must install and configure all of the following dependencies on your machine:
...
To build the final jar and optimize the posdevicerestapi application for production, run:
