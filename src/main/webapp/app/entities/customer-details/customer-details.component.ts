...
export default class CustomerDetails extends Vue {
  ...
  public retrieveAllCustomerDetailss(): void {
  ...
  public prepareRemove(instance: ICustomerDetails): void {
  ...
  public removeCustomerDetails(): void {
    this.customerDetailsService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('posdevicerestapiApp.customerDetails.deleted', { param: this.removeId });
