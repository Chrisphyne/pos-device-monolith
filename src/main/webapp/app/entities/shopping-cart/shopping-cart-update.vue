    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          ...
          v-text="$t('posdevicerestapiApp.shoppingCart.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('posdevicerestapiApp.shoppingCart.placedDate')" for="shopping-cart-placedDate"
              >Placed Date</label
            >
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('posdevicerestapiApp.shoppingCart.status')" for="shopping-cart-status"
              >Status</label
            >
            <select
              class="form-control"
              ...
              required
            >
              <option value="COMPLETED" v-bind:label="$t('posdevicerestapiApp.OrderStatus.COMPLETED')">COMPLETED</option>
              <option value="PAID" v-bind:label="$t('posdevicerestapiApp.OrderStatus.PAID')">PAID</option>
              <option value="PENDING" v-bind:label="$t('posdevicerestapiApp.OrderStatus.PENDING')">PENDING</option>
              <option value="CANCELLED" v-bind:label="$t('posdevicerestapiApp.OrderStatus.CANCELLED')">CANCELLED</option>
              <option value="REFUNDED" v-bind:label="$t('posdevicerestapiApp.OrderStatus.REFUNDED')">REFUNDED</option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('posdevicerestapiApp.shoppingCart.totalPrice')" for="shopping-cart-totalPrice"
              >Total Price</label
            >
            <input
              type="number"
          ...
          <div class="form-group">
            <label
              ...
              v-text="$t('posdevicerestapiApp.shoppingCart.paymentMethod')"
            ...
            <select
              ...
              required
            >
              <option value="CREDIT_CARD" v-bind:label="$t('posdevicerestapiApp.PaymentMethod.CREDIT_CARD')">card</option>
              <option value="IDEAL" v-bind:label="$t('posdevicerestapiApp.PaymentMethod.IDEAL')">ideal</option>
            </select>
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('posdevicerestapiApp.shoppingCart.paymentReference')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('posdevicerestapiApp.shoppingCart.customerDetails')"
