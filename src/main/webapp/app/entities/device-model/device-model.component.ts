...
export default class DeviceModel extends Vue {
  ...
  public retrieveAllDeviceModels(): void {
  ...
  public prepareRemove(instance: IDeviceModel): void {
  ...
  public removeDeviceModel(): void {
    this.deviceModelService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('posdevicerestapiApp.deviceModel.deleted', { param: this.removeId });
