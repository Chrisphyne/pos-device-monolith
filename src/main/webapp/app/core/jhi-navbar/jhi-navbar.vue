<template>
  <b-navbar data-cy="navbar" toggleable="md" type="dark" class="jh-navbar">
    <b-navbar-brand class="logo" b-link to="/">
      ...
      <span v-text="$t('global.title')" class="navbar-title">posdevicerestapi</span> <span class="navbar-version">{{ version }}</span>
    </b-navbar-brand>
    <b-navbar-toggle
      right
    ...
    <b-collapse is-nav id="header-tabs">
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item-dropdown right id="entity-menu" v-if="authenticated" active-class="active" class="pointer" data-cy="entity">
          ...
          <b-dropdown-item to="/device-model">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.deviceModel')">Device Model</span>
          </b-dropdown-item>
          <b-dropdown-item to="/customer-details">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.customerDetails')">Customer Details</span>
          </b-dropdown-item>
          <b-dropdown-item to="/shopping-cart">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.shoppingCart')">Shopping Cart</span>
          </b-dropdown-item>
          <b-dropdown-item to="/device-order">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.deviceOrder')">Device Order</span>
          </b-dropdown-item>
