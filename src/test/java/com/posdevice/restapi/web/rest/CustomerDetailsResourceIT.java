...
import com.posdevice.restapi.domain.CustomerDetails;
import com.posdevice.restapi.domain.User;
import com.posdevice.restapi.domain.enumeration.Gender;
import com.posdevice.restapi.repository.CustomerDetailsRepository;
...
class CustomerDetailsResourceIT {
    ...
    void createCustomerDetails() throws Exception {
        ...
        assertThat(testCustomerDetails.getBranch()).isEqualTo(DEFAULT_BRANCH);
    ...
    void checkBranchIsRequired() throws Exception {
        int databaseSizeBeforeTest = customerDetailsRepository.findAll().size();
        // set the field null
        customerDetails.setBranch(null);
    ...
    void putNewCustomerDetails() throws Exception {
        ...
        assertThat(testCustomerDetails.getBranch()).isEqualTo(UPDATED_BRANCH);
    ...
    void partialUpdateCustomerDetailsWithPatch() throws Exception {
        ...
        partialUpdatedCustomerDetails.phone(UPDATED_PHONE).addressLine1(UPDATED_ADDRESS_LINE_1).branch(UPDATED_BRANCH);
